...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.authorNameLabel.font = FONT_MEDIUM(15);
        ...
        self.contentLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, self.titleLabel.frame.origin.y + self.titleLabel.frame.size.height + 0, screenWidth - 20, 60)];
        ...
        /*
        UIImageView *iconImageView = [[UIImageView alloc]initWithFrame:CGRectMake(screenWidth/2 - 23, self.postImageView.frame.size.height/2 - 25, 93 / 2, 99 / 2)];
        iconImageView.image = [UIImage imageNamed:@"iconvideo"];
        iconImageView.userInteractionEnabled = YES;
        [_postImageView addSubview:iconImageView];
        */
